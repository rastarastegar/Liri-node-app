...
1. LIRI will display your latest tweets. As we do not want to display your personal account, or its keys, please make an alias account and add a few tweets to it! ( created an account with my name and the password is Houston2018)
...
2. Make a .gitignore file and add the following lines to it. This will tell git not to track these files, and thus they won't be committed to Github. .gitignore doesnt need a name and it is for linux communication.
